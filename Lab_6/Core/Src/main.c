...
/* Private macro -------------------------------------------------------------*/
/* USER CODE BEGIN PM */
#define DEBUG_TX2_STR(s) HAL_UART_Transmit(&huart2, (uint8_t*)(s), (uint16_t)strlen(s), HAL_MAX_DELAY)
/* USER CODE END PM */
...
/* USER CODE BEGIN PV */
static uint8_t rx3_byte;   // búfer de 1 byte para recepción por IT
/* USER CODE END PV */
